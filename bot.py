...
async def send_alert(
    ...
    Die Bilder werden als mehrere Attachments in dieselbe
    Nachricht geladen. Discord zeigt mehrere Bilder in einer
    gemeinsamen Galerie an.
    """
    ...
    # Diese Angaben stehen bewusst VOR den Bildern.
    embed.add_field(
        name="PREIS",
        value=f"**{price} EUR**",
        inline=True,
    ...
    # --------------------------------------------------------
    # STEUERUNGSMODUL GANZ NACH UNTEN
    # --------------------------------------------------------
